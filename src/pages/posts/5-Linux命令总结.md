...
<img src="https://data.skywangdev.com/blog/S-7.jpeg" width="800" />
...
## [](#8-文件的权限-使用--设置权限，使用---用于取消)8\. 文件的权限 使用 “+” 设置权限，使用 “-” 用于取消
...
## [](#9-文件的特殊属性-，使用--设置权限，使用---用于取消)9\. 文件的特殊属性 ，使用 “+” 设置权限，使用 “-” 用于取消
...
## [](#22-网络（以太网和-wifi-无线）)22\. 网络（以太网和 WIFI 无线）
...
### [](#267、ctrlc-终止当前的命令)26.7、ctrl+c :终止当前的命令

### [](#268、who-或-w-命令)26.8、who 或 w 命令

功能：查看当前系统中有哪些用户登录

格式：who/w\[参数\]

### [](#269、dmesg-命令)26.9、dmesg 命令

功能：显示系统诊断信息、操作系统版本号、物理内存的大小以及其它信息

### [](#2610、df-命令)26.10、df 命令

功能：用于查看文件系统的各个分区的占用情况

### [](#2611、du-命令)26.11、du 命令

功能：查看某个目录中各级子目录所使用的硬盘空间数

格式：du \[参数\] <目录名>

### [](#2612、free-命令)26.12、free 命令
